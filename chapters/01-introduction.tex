...
Vorteil bieten. Unternehmen wie Doctolib haben sich bereits früh das Ziel gesetzt, die 
...
Die Arbeit gliedert sich wie folgt: \cref{ch:grundlagen} erläutert die technischen 
Grundlagen. \cref{ch:anforderungen} analysiert Nutzergruppen, Anforderungen und 
Abgrenzungen. \cref{ch:design} beschreibt Design, Architektur und Datenschutz. 
\cref{ch:implementierung} dokumentiert die Implementierung. \cref{ch:evaluation} evaluiert 
die Lösung. \cref{ch:fazit} fasst zusammen und gibt einen Ausblick.
