...
\begin{itemize}
    ...
    ermöglichen, sich mit einer E-Mail-Adresse oder Telefonnummer sowie 
    einem Passwort zu registrieren und anzumelden.

    \item \textbf{FA\#02} Die mobile Anwendung \textbf{muss} eine Anmeldung per biometrischer Authentifizierung (Face~ID / Fingerabdruck) unterstützen.
    ...
    und Geburtsdatum zu erstellen, zu bearbeiten und zu löschen.

    \item \textbf{FA\#04} Die mobile Anwendung \textbf{muss} das Hochladen 
    von Profilbildern direkt über die Gerätekamera oder Galerie ermöglichen.

    \item \textbf{FA\#05} Die mobile Anwendung \textbf{muss} Nutzenden 
    ermöglichen, Tierarztpraxen anhand von Standort, Tierart oder Behandlung zu suchen und zu filtern.

    \item \textbf{FA\#06} Die mobile Anwendung \textbf{muss} Nutzenden 
    ermöglichen, freie Terminslots in einer scrollbaren Kalenderansicht 
    einzusehen.

    \item \textbf{FA\#07} Die mobile Anwendung \textbf{muss} Nutzenden 
    ermöglichen, einen freien Terminslot unter Angabe von Behandlungsart 
    und Haustier zu buchen.

    \item \textbf{FA\#08} Die mobile Anwendung \textbf{muss} Nutzenden 
    ermöglichen, gebuchte Termine einzusehen, zu stornieren und umzubuchen.

    \item \textbf{FA\#09} Die mobile Anwendung \textbf{muss} Nutzende 
    per Push-Benachrichtigung über Änderungen oder Stornierungen 
    gebuchter Termine informieren.

    \item \textbf{FA\#10} Die mobile Anwendung \textbf{muss} Nutzenden 
    automatische Terminerinnerungen per E-Mail und Push-Benachrichtigung zusenden.
\end{itemize}

\textbf{Tierarztpraxen}
\begin{itemize}
    \item \textbf{FA\#11} Die mobile Anwendung \textbf{muss} Tierarztpraxen ermöglichen, Stammdaten, Öffnungszeiten, behandelte Tierarten und Spezialisierungen eigenständig zu verwalten.

    \item \textbf{FA\#12} Die mobile Anwendung \textbf{muss} Tierarztpraxen ermöglichen, verfügbare Terminslots über eine Kalenderoberfläche zu definieren und Zeiträume zu sperren.

    \item \textbf{FA\#13} Die mobile Anwendung \textbf{muss} Praxen 
    ermöglichen, alle Buchungen in einer Tages- und 
    Wochenansicht einzusehen.

    \item \textbf{FA\#14} Die mobile Anwendung \textbf{muss} Praxen 
    ermöglichen, Termine abzusagen.

    \item \textbf{FA\#15} Die mobile Anwendung \textbf{muss} betroffene 
    Tierhalter bei einer Terminabsage durch die Praxis automatisch per 
    Push-Benachrichtigung und E-Mail benachrichtigen.
\end{itemize}
...
\begin{itemize}
    \item \textbf{NFA\#01} Die mobile Anwendung \textbf{muss} Seiteninhalte unter Normallast in unter drei Sekunden laden, gemessen unter einer 4G-Mobilfunkverbindung (LTE).

    \item \textbf{NFA\#02} Die mobile Anwendung \textbf{muss} eine 
    Verfügbarkeit von mindestens 99{,}5 Prozent gewährleisten, einschließlich der zugehörigen Backend-Dienste und APIs.

    \item \textbf{NFA\#03} Die mobile Anwendung \textbf{muss} alle 
    Datenübertragungen per Hypertext Transfer Protocol Secure (HTTPS) verschlüsseln.

    \item \textbf{NFA\#04} Die mobile Anwendung \textbf{muss} Passwörter 
    ausschließlich in gehashter Form speichern und sensible Daten nicht im Klartext auf dem Gerät ablegen.

    \item \textbf{NFA\#05} Die mobile Anwendung \textbf{muss} 
    personenbezogene Daten in Übereinstimmung mit der 
    Datenschutz-Grundverordnung (DSGVO) verarbeiten.

    \item \textbf{NFA\#06} Die mobile Anwendung \textbf{muss} vor dem 
    Zugriff auf Gerätedaten eine explizite Einwilligung der Nutzenden einholen.

    \item \textbf{NFA\#07} Die mobile Anwendung \textbf{muss} den 
    Buchungsvorgang in maximal fünf Schritten abschließbar machen, die 
    jeweils ohne horizontales Scrollen darstellbar sind.

    \item \textbf{NFA\#08} Die mobile Anwendung \textbf{muss} auf 
    Endgeräten mit einer Mindestbildschirmbreite von 320 Pixeln 
    vollständig nutzbar sein.

    \item \textbf{NFA\#09} Alle interaktiven Elemente \textbf{müssen} 
    eine Mindestgröße von 44\,×\,44\,px (iOS) bzw. 48\,×\,48\,dp 
    (Android) aufweisen.

    \item \textbf{NFA\#10} Die mobile Anwendung \textbf{soll} ein 
    Wachstum der Nutzerzahlen um den Faktor zehn durch skalierbare 
    Cloud-Infrastruktur ohne Anpassung der Systemarchitektur tragen können.
\end{itemize}

\section{Use Cases}

Use Cases stellen das Verhalten eines Systems aus dem Blickwinkel der Nutzenden dar. Sie beschreiben, wie das System auf eine Interaktion reagiert, welche Ziele damit verfolgt werden und welche alternativen Abläufe dabei auftreten können \cite[S.~15]{cockburn2001}. Aufgrund ihrer textuellen Form eignen sie sich besonders zur klaren und verständlichen Beschreibung funktionaler Anforderungen und ermöglichen eine verständliche Kommunikation ohne besondere fachliche Vorkenntnisse \cite[S.~15]{cockburn2001}. Zur besseren Dokumentation werden sie im Folgenden durch ein Use-Case-Diagramm ergänzt \cite[S.~75]{pohl2021}.

\subsection{Konto registrieren}

\renewcommand{\arraystretch}{1.5}
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-01: Konto registrieren \\
\hline
\textbf{Kurzbeschreibung} & Ein Tierhalter möchte sich registrieren \\
\hline
\textbf{Akteure} & Tierhalter \\
\hline
\textbf{Vorbedingungen} & 
Der Tierhalter besitzt noch kein Konto in der Anwendung. \newline
Der Tierhalter besitzt eine gültige E-Mail-Adresse oder Telefonnummer. \\
\hline
\textbf{Auslösendes Ereignis} & Der Tierhalter möchte die Anwendung 
erstmalig nutzen und besitzt noch kein Konto. \\
\hline
\textbf{Hauptszenario} &
1. Der Tierhalter öffnet die mobile Anwendung von petappoint. \newline
2. Der Tierhalter tippt auf „Registrieren". \newline
3. Die Anwendung zeigt ein Registrierungsformular. \newline
4. Der Tierhalter gibt Vorname, Nachname, E-Mail-Adresse oder 
Telefonnummer, Passwort, Straße und PLZ an. \newline
5. Der Tierhalter tippt auf „Konto erstellen". \newline
6. Die Anwendung validiert die Eingaben. \newline
7. Die Anwendung versendet einen Verifizierungscode an die angegebene 
E-Mail-Adresse oder Telefonnummer. \newline
8. Der Tierhalter wird zur Eingabe des Verifizierungscodes weitergeleitet. \newline
9. Der Tierhalter gibt den Code ein und tippt auf „Bestätigen". \newline
10. Der Tierhalter wird automatisch eingeloggt und zur 
Startübersicht weitergeleitet. \\
\hline
\textbf{Alternativszenario} &
1. Die E-Mail-Adresse oder die Telefonnummer ist bereits vergeben 
$\rightarrow$ Die Anwendung zeigt eine Fehlermeldung. \newline
2. Das Passwort erfüllt nicht die Mindestanforderungen 
$\rightarrow$ Die Anwendung zeigt einen Hinweis. \newline
3. Pflichtfelder sind leer $\rightarrow$ Der Button bleibt deaktiviert. \newline
4. Der Tierhalter möchte sich bei einem Folgebesuch anmelden 
$\rightarrow$ Die Anwendung bietet eine Anmeldung per 
biometrischer Authentifizierung (Face~ID / Fingerabdruck) an. \\
\hline
\textbf{Nachbedingungen} &
Das Konto des Tierhalters ist in der Anwendung gespeichert. \newline
...
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-02: Haustier anlegen \\
\hline
...
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-03: Haustier bearbeiten \\
\hline
...
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-04: Haustier löschen \\
\hline
...
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-05: Termin buchen \\
\hline
...
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-06: Termin bearbeiten \\
\hline
...
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-07: Termin stornieren \\
\hline
...
\subsection{Terminslots verwalten}
\renewcommand{\arraystretch}{1.5}
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-08: Terminslots verwalten \\
\hline
\textbf{Kurzbeschreibung} & Die Tierarztpraxis definiert verfügbare 
Terminslots und sperrt Zeiträume in der mobilen Anwendung. \\
\hline
...
\hline
\textbf{Auslösendes Ereignis} & Die Tierarztpraxis möchte verfügbare 
Terminslots festlegen oder Zeiträume sperren. \\
\hline
\textbf{Hauptszenario} &
...
\begin{tabular}{|p{5cm}|p{9.2cm}|}
\hline
\textbf{Name} & UC-09: Buchungen einsehen \\
\hline
