...
Methodisch folgt die Arbeit dem Ansatz des Design Science Research nach Hevner et~al.~\cite{hevner2004},
...
von 100\,\% entspricht. Der bereinigte durchschnittliche System Usability Scale\,(SUS)-Score
von 94,34 entspricht der Note~A und belegt eine hohe wahrgenommene
Benutzerfreundlichkeit auf beiden Plattformen. Die Ergebnisse zeigen, dass eine
...
Es wurden folgende KI-Tools verwendet: Claude Sonnet 4.6 (Anthropic), Perplexity Sonar 2 (Perplexity AI), v0 (Vercel) sowie DeepL (DeepL SE). Etwaige durch die KI vorgenommenen Änderungen
