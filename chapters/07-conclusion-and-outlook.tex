...
Terminbuchungsprozess. Da das Backend von petappoint im Rahmen eines 
...
belegt eine sehr hohe wahrgenommene Gebrauchstauglichkeit. Der 
...
wird. Der durchschnittliche SUS-Score von 94,34 übertraf dabei 
die eigenen Erwartungen und verdeutlicht, dass eine konsequente 
Fokussierung auf die Kernfunktionen einer Zielgruppe zu einer 
hohen Nutzerzufriedenheit führen kann.
...
frühzeitig zu erweitern. Diese Entscheidung erwies sich im 
Nachhinein als richtig, da sie eine solide und getestete 
Grundlage für die Weiterentwicklung der Anwendung schafft.
...
solcher Lösungen ermöglicht. Das langfristige Ziel ist es, 
petappoint um die Tierarztpraxis-Rolle zu erweitern und die 
Anwendung als vollständige Lösung auf den Markt zu bringen.

\section{Ausblick}
Die vorliegende Arbeit bildet eine solide Grundlage für die 
Weiterentwicklung von petappoint. Zunächst sollten die im Rahmen 
...
kann petappoint als vollständige Terminverwaltungslösung auf dem 
...
Farben für Tierprofile auszuwählen sowie die allgemeine 
Benutzeroberfläche ansprechender zu gestalten, um die 
Nutzerzufriedenheit weiter zu steigern.