...
\begin{itemize}
    ...
    \item \textbf{NFA\#03} Die mobile Anwendung muss ein helles (Light) sowie ein dunkles (Dark) Farbschema unterstützen, das der Nutzende manuell über einen Schalter in der Anwendung wechseln kann.

    \item \textbf{NFA\#04} Die mobile Anwendung muss in den Sprachen Deutsch und Englisch verfügbar sein.

    \item \textbf{NFA\#05} Die Anwendung muss dem Nutzenden durch Statusmeldungen Rückmeldung über abgeschlossene Aktionen geben.
\end{itemize}
